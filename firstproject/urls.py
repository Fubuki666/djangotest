...
urlpatterns = [
    ...
    path('newsadm/index/', nviews.index),
    path('newsadm/index/<str:pageindex>/', nviews.index),
    path('newsadm/detail/<int:detailid>/', nviews.detail),
    path('newsadm/login/', nviews.login),
    path('newsadm/logout/', nviews.logout),
    path('newsadm/adminmain/', nviews.adminmain),
    path('newsadm/adminmain/<str:pageindex>/', nviews.adminmain),
    path('newsadm/newsadd/', nviews.newsadd),
    path('newsadm/newsedit/<int:newsid>/', nviews.newsedit),
    path('newsadm/newsedit/<int:newsid>/<str:edittype>/', nviews.newsedit),
    path('newsadm/newsdelete/<int:newsid>/', nviews.newsdelete),
    path('newsadm/newsdelete/<int:newsid>/<str:deletetype>/', nviews.newsdelete),
